...
- **Output**: `ARK Locator-0.2.1.AppImage`
- **Size**: ~200MB
...
```
dist/
├── ARK Locator-0.2.1-arm64.dmg          # macOS installer
├── ARK Locator-0.2.1-arm64-mac.zip      # macOS portable
├── ARK Locator Setup 0.2.1.exe          # Windows installer
├── ARK Locator-0.2.1.AppImage           # Linux portable
